...
export interface IEditionMaxMinterInterface extends utils.Interface {
  functions: {
...
export interface IEditionMaxMinter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEditionMaxMinterInterface;
