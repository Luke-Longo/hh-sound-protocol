...
export interface EditionMaxMinterInterface extends utils.Interface {
  functions: {
    "MAX_BPS()": FunctionFragment;
    "affiliateFeesAccrued(address)": FunctionFragment;
    "createEditionMint(address,uint96,uint32,uint32,uint16,uint32)": FunctionFragment;
  ...
  events: {
    ...
    "EditionMaxMintCreated(address,uint128,uint96,uint32,uint32,uint16,uint32)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "EditionMaxMintCreated"): EventFragment;
...
export interface EditionMaxMintCreatedEventObject {
  edition: string;
  mintId: BigNumber;
  price: BigNumber;
  startTime: number;
...
export type EditionMaxMintCreatedEvent = TypedEvent<
  [string, BigNumber, BigNumber, number, number, number, number],
  EditionMaxMintCreatedEventObject
>;

export type EditionMaxMintCreatedEventFilter =
  TypedEventFilter<EditionMaxMintCreatedEvent>;
...
export interface EditionMaxMinter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EditionMaxMinterInterface;
  ...
  functions: {
    ...
    mintInfo(
      ...
      mintId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[MintInfoStructOutput] & { info: MintInfoStructOutput }>;
  ...
  filters: {
    ...
    "EditionMaxMintCreated(address,uint128,uint96,uint32,uint32,uint16,uint32)"(
      edition?: PromiseOrValue<string> | null,
      mintId?: PromiseOrValue<BigNumberish> | null,
      price?: null,
      startTime?: null,
    ...
    ): EditionMaxMintCreatedEventFilter;
