...
import type {
  IEditionMaxMinter,
  IEditionMaxMinterInterface,
} from "../../../../contracts/modules/interfaces/IEditionMaxMinter";
...
export class IEditionMaxMinter__factory {
  static readonly abi = _abi;
  static createInterface(): IEditionMaxMinterInterface {
    return new utils.Interface(_abi) as IEditionMaxMinterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IEditionMaxMinter {
    return new Contract(address, _abi, signerOrProvider) as IEditionMaxMinter;
  }
}
